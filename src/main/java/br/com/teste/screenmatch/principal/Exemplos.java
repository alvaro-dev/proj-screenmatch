...
public class Exemplos {
    public static void main(String[] args) {
        ...
        System.out.println("numerosPares:" + numerosPares); // Output: [2, 4, 6, 8, 10]
...
// Olá, Ana!
        ...
        System.out.println("numbersPares:" + numbersPares); // Output: [2, 4, 6, 8, 10]
        ...
        System.out.println("listaImutavel: " + listaImutavel);
    }
}
